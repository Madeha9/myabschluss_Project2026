/**
 * Verification tests for the persistence layer and data integrity.
 * This package ensures that CRUD operations, schema constraints, and
 * data mapping logic work correctly in isolation before integration.
 */
