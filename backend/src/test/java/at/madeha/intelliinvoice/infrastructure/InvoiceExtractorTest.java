...
public class InvoiceExtractorTest {
    ...
    void testInvoiceExtraction() {
         ...
         */
        String result = String.valueOf(invoiceExtractor.extract(url));
        // Assertions
        ...
        // This regex looks for a digit followed by a decimal and two more digits//boolean containsPrice = result.matches(".*\\d+\\.\\d{2}.*");
