 ...
 */
/*
a helper Class as Record only to hall the data  to set the invoice status and the day left to return the invoice ,
 it is  the Class record only to handle data
